...
#define __PYX_HAVE__src__key
#define __PYX_HAVE_API__src__key
/* Early includes */
...
#define __Pyx_MODULE_NAME "src.key"
extern int __pyx_module_is_main_src__key;
int __pyx_module_is_main_src__key = 0;

/* Implementation of 'src.key' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_src__key) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.key")) {
      if (unlikely(PyDict_SetItemString(modules, "src.key", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.key", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.key");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
