...
#define __PYX_HAVE__src__iostream
#define __PYX_HAVE_API__src__iostream
/* Early includes */
#include <string.h>
#include "ios"
#include "new"
...
/* Module declarations from 'src.std_iostream' */

/* Module declarations from 'src.query' */

/* Module declarations from 'src.key' */

/* Module declarations from 'src.agent' */

/* Module declarations from 'src.base' */

/* Module declarations from 'src.keyset' */

/* Module declarations from 'src.trie' */

/* Module declarations from 'src.iostream' */
#define __Pyx_MODULE_NAME "src.iostream"
extern int __pyx_module_is_main_src__iostream;
int __pyx_module_is_main_src__iostream = 0;

/* Implementation of 'src.iostream' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_src__iostream) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.iostream")) {
      if (unlikely(PyDict_SetItemString(modules, "src.iostream", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.iostream", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.iostream");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
